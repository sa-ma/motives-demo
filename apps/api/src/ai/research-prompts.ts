...
export function buildSessionDebriefPrompt(input: {
  ...
  return [
    ...
    "Use this strict top theme rubric:",
    "- high themes must use strength high and score 4.",
    "- medium themes must use strength medium and score 3.",
    "- low themes must use strength low and score 2.",
